...
A subtree of a binary tree tree is a tree that consists of a node in tree and all of this node's descendants. The tree tree could also be considered as a subtree of itself.
    ...
    \begin{enumerate}
      ...
      \item[-] Once this exploration and checking has been done, if the result is true, we must return True, if it's not, we can  \textit{keep exploring} the main rooted tree. 
